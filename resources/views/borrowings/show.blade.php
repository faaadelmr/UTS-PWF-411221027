        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="mb-6">
                        <h3 class="text-lg font-semibold text-gray-800">Borrowing #{{ $borrowing->borrowing_id }}</h3>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <h4 class="font-medium text-gray-700 mb-2">Borrowing Information</h4>
                        ...
                        <div>
                            <h4 class="font-medium text-gray-700 mb-2">Book Details</h4>
                            <div class="bg-gray-50 p-4 rounded">
                                <p class="mb-2">
                                ...
                                <p class="mb-2">
                                    <span class="font-medium">Year Published:</span> 
                                    {{ $borrowing->book->year_published ?? 'Not specified' }}
                                </p>
                                <p class="mb-2">
                                    <span class="font-medium">Current Availability:</span> 
                                    <span class="{{ $borrowing->book->quantity_available > 0 ? 'text-green-600' : 'text-red-600' }}">
                                        {{ $borrowing->book->quantity_available }} copies available
                                    </span>
                                </p>
                            </div>
